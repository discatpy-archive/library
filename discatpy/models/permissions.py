...
class PermissionOverwrite:
    ...
    def __init__(
        self,
        *,
        create_instant_invite: t.Optional[bool] = ...,
        kick_members: t.Optional[bool] = ...,
        ban_members: t.Optional[bool] = ...,
        administrator: t.Optional[bool] = ...,
        manage_channels: t.Optional[bool] = ...,
        manage_guild: t.Optional[bool] = ...,
        add_reactions: t.Optional[bool] = ...,
        view_audit_log: t.Optional[bool] = ...,
        priority_speaker: t.Optional[bool] = ...,
        stream: t.Optional[bool] = ...,
        view_channel: t.Optional[bool] = ...,
        send_messages: t.Optional[bool] = ...,
        send_tts_messages: t.Optional[bool] = ...,
        manage_messages: t.Optional[bool] = ...,
        embed_links: t.Optional[bool] = ...,
        attach_files: t.Optional[bool] = ...,
        read_message_history: t.Optional[bool] = ...,
        mention_everyone: t.Optional[bool] = ...,
        use_external_emojis: t.Optional[bool] = ...,
        view_guild_insights: t.Optional[bool] = ...,
        connect: t.Optional[bool] = ...,
        speak: t.Optional[bool] = ...,
        mute_members: t.Optional[bool] = ...,
        deafen_members: t.Optional[bool] = ...,
        move_members: t.Optional[bool] = ...,
        use_vad: t.Optional[bool] = ...,
        change_nickname: t.Optional[bool] = ...,
        manage_nicknames: t.Optional[bool] = ...,
        manage_roles: t.Optional[bool] = ...,
        manage_webhooks: t.Optional[bool] = ...,
        manage_emojis_and_stickers: t.Optional[bool] = ...,
        use_application_commands: t.Optional[bool] = ...,
        request_to_speak: t.Optional[bool] = ...,
        manage_threads: t.Optional[bool] = ...,
        create_public_threads: t.Optional[bool] = ...,
        create_private_threads: t.Optional[bool] = ...,
        use_external_stickers: t.Optional[bool] = ...,
        send_messages_in_threads: t.Optional[bool] = ...,
        use_embed_activities: t.Optional[bool] = ...,
        moderate_members: t.Optional[bool] = ...,
    ) -> None:
        ...
